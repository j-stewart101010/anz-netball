		...
		<header class="master-head">
			<div class="branding col-md-4">
				<div class="brand clearfix">
					...
					<a data-toggle="collapse" href="#main-navigation" class="menu-icon">
		...
		<main class="content home">
			...
			<section class="grid visible-xs">
				...
				<div class="col col-sm-12 col-md-2 col-lg-2">
					<div class="outter-tile group">
						<article class="instruction-tile tile center shade-three">
							<h1 class="heading heading-lg verbose">DISCOVER</h1>
							<p class="verbose">Tap an image to discover how netball is enriching lives.</p>
							<img src="images/subimage-click.png" alt="Click to discover">
						</article>
					</div>
				</div>
										...
										<hgroup>
											<div>
												<h2 class="tile-heading heading-sm">
													<div class="brand-overlay shade-one"></div>
							...
							<div class="front shade-eleven clearfix">
								...
								<div class="col col-xs-12 col-sm-12 col-md-2 col-lg-2">
									<div class="col col-xs-6">
										<div id="image-container-one" class="image-wrap">
											<a data-toggle="collapse" data-target="#user-story-one" data-enlage="toggle" data-enlarge-target="#user-story-image-one" data-enlarge-to-target="#user-story-box-one" href="#">
									...
									<div class="col col-xs-6">
										<div class="image-wrap">
											<a data-toggle="collapse" data-target="#user-story-two"  data-enlage="toggle" data-enlarge-target="#user-story-image-two" data-enlarge-to-target="#user-story-box-one" href="#">
												<img src="http://lorempixel.com/g/612/612/">									
											</a>
										</div>
									</div>	
								...
								<div class="col col-xs-12 col-sm-12 col-md-2 col-lg-2">
									<div class="col col-xs-6">
										...
										<div id="image-container-two" class="image-wrap">
											<a data-toggle="collapse" data-target="#user-story-three" data-enlage="toggle" data-enlarge-target="#user-story-image-three" data-enlarge-to-target="#user-story-box-one" href="#">
												<img src="http://lorempixel.com/g/612/612/">									
											</a>
										</div>
									...
									<div class="col col-xs-6 col-md-12">
										<div class="outter-tile group shade-two">
											<article data-resize-height="#image-container-two" class="content-tile mini tile center">
								...
								<div id="user-story-image-one" class="collapse image-wrap enlarge top left">
									<a data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
										<img src="http://lorempixel.com/g/612/612/">
									</a>
								</div>

								<div id="user-story-image-two" class="collapse image-wrap enlarge top right">
									<a data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
										<img src="http://lorempixel.com/g/612/612/">
									</a>
								</div>

								<div id="user-story-image-three" class="collapse image-wrap enlarge bottom left">
									<a data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
										<img src="http://lorempixel.com/g/612/612/">
									</a>
								</div>								
							...
							<div class="back shade-eleven">
								...
								<a id="user-story-one" class="outter-tile shade-three collapse" data-enlage="toggle" data-enlarge-target="#user-story-image-one" data-enlarge-to-target="#user-story-box-one" data-toggle="collapse" data-target="#user-story-one" data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
									<article class="story-tile content-tile tile">
										<div class="media">
											<div class="pull-left" href="#"><img alt="Net183 Avatar" src="images/sample-avatar-one.jpg"></div>
											<div class="media-body">
												<h3 class="subheading verbose">Net183</h3>
												<span>Kaitlin Alves</span><br>
												<span>26 years old. Veterinary nurse.</span>
												<p class="verbose">Keeping Jen company at the Box Hill high courts, and giving her one or two coaching tips to share with the juniors. LOL ;)</p>
												<p class="verbose"><small>#netballnation #besties #nothingbutlove #iheartnetball #teamplayer</small></p>
											</div>
										</div>
									</article>
								</a>

								<a id="user-story-two" class="outter-tile shade-three collapse" data-enlage="toggle" data-enlarge-target="#user-story-image-two" data-enlarge-to-target="#user-story-box-one" data-toggle="collapse" data-target="#user-story-two" data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
									<article class="story-tile content-tile tile">
										<div class="media">
											<div class="pull-left" href="#"><img alt="Net183 Avatar" src="images/sample-avatar-one.jpg"></div>
											<div class="media-body">
												<h3 class="subheading verbose">Net183 2</h3>
												<span>Kaitlin Alves</span><br>
												<span>26 years old. Veterinary nurse.</span>
												<p class="verbose">Keeping Jen company at the Box Hill high courts, and giving her one or two coaching tips to share with the juniors. LOL ;)</p>
												<p class="verbose"><small>#netballnation #besties #nothingbutlove #iheartnetball #teamplayer</small></p>
								...
								<a id="user-story-three" class="outter-tile shade-three collapse" data-enlage="toggle" data-enlarge-target="#user-story-image-three" data-enlarge-to-target="#user-story-box-one" data-toggle="collapse" data-target="#user-story-three" data-flip="toggle" data-flip-target="#user-story-box-one" href="#">
									<article class="story-tile content-tile tile">
										<div class="media">
											<div class="pull-left" href="#"><img alt="Net183 Avatar" src="images/sample-avatar-one.jpg"></div>
											<div class="media-body">
		...
		<footer class="master-foot">
			<div class="nav-items">
				<ul class="navigation horizontal">
					<li><a href="/">anz.com</a></li>
					<li><a href="/">ANZ NetSetGo</a></li>
					<li><a href="/">ANZ Championship</a></li>
