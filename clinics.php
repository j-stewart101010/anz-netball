						...
						<div class="grid three-quarters-length">
							<div class="col col-md-12 col-lg-12 center-tile shade-fourteen">
								<div data-resize-height="center" class="outter-tile">
									<article class="content-tile tile">
										<hgroup>
											<h1 class="heading heading-exjumbo tanned">Register</h1>
											<h2 class="subheading heading-med tanned">Don’t miss out! We’re running clinics nation wide.</h2>
											<a class="btn btn-sm btn-default" href="#">Register for 2014 clinics via facebook <i class="fa fa-angle-right"></i></a>
										</hgroup>
									</article>
								</div>
							</div>
